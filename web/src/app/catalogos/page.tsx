...
export default function CatalogsPage() {
  ...
  const catalogs = [
        { id:1, title: 'Mágica NAVIDAD', image: '/images/catalogos/catalogoportada2.jpg', description:'Catálogo vigente' },
        { id:2, title: 'Tendencias de verano', image: '/images/catalogos/catalogoportada.jpg', description:'Próxima campaña' },
        { id:3, title: 'Verano con estilo!', image: '/images/catalogos/catalogoportada3.jpg', description:'Próxima campaña' },
    ];
